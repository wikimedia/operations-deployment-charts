...
if ( getenv('ENABLE_VISUAL_EDITOR') === "true" ) {
    # visual editor
    wfLoadExtension( 'VisualEditor' );
    // Enable by default for everybody
    $wgDefaultUserOptions['visualeditor-enable'] = 1;

    $restbaseUrl = getenv( 'RESTBASE_URL' );
    $domain = getenv( 'MEDIAWIKI_DOMAIN' );
    ...
    if ( $restbaseUrl !== '' ) {
        ...
        if ( getenv( 'IS_RESTBASE_EXTERNAL' ) === "true" ){
            $wgVisualEditorFullRestbaseURL =  'http://' . $restbaseUrl . '/' . $domain . '/';
        } else {
            $wgVisualEditorFullRestbaseURL = 'http://' . $wgServerName . ':' . getenv( 'RESTBASE_NODEPORT' ) . '/' . $domain . '/';
        }
    } else {
