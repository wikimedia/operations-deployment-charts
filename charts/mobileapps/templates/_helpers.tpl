...
{{- define "mobileapps.chartname" -}}
{{- default .Chart.Name .Values.chartName | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "mobileapps.releasename" -}}
{{- $name := default .Chart.Name .Values.chartName -}}
{{- printf "%s-%s" $name .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "mobileapps.chartid" -}}
{{ .Chart.Name }}-{{ .Chart.Version | replace "+" "_" }}
{{- end -}}

{{- define "mobileapps.appbaseurl" -}}
http://{{ template "mobileapps.releasename" . }}:{{ .Values.main_app.appbase_url_port }}
{{- end -}}
