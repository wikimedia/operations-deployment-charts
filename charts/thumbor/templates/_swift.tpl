...
# Experiment (T433964)
SWIFT_THUMBNAIL_EXPIRY_SECONDS = 172800
SWIFT_THUMBNAIL_RECENCY_AGE_SECONDS = 172800
SWIFT_THUMBNAIL_EXPIRY_CONTAINERS = [ 'wikipedia-commons-local-thumb.33', 'wikipedia-commons-local-thumb.43' ]
{{- end }}
