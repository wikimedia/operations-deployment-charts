...
<policymap>
  ...
  <policy domain="module" rights="read|write" pattern="{GIF,JPG,JPEG,PNG,PNG32,WEBP,TIFF,TIF,BMP,XCF,PPM,PNM}" />
  <policy domain="coder" rights="read|write" pattern="{GIF,JPG,JPEG,PNG,PNG32,WEBP,TIFF,TIF,BMP,XCF,PPM,PNM}" />
</policymap>
{{ end }}
