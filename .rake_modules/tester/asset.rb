...
module Tester
  ...
  class HelmfileAsset < BaseTestAsset
    ENV_EXPLORE = %w[staging eqiad ml-serve-eqiad ml-staging-codfw dse-k8s-eqiad dse-k8s-codfw aux-k8s-eqiad aux-k8s-codfw].freeze
    LISTENERS_FIXTURE = '.fixtures/service_proxy.yaml'
    ...
    def collect_fixtures(chdir = nil)
      ...
      puts "Unable to build helmfile #{@name} (#{real_path}) for any environment. Last error was:".red
      puts res.err.red
    end
